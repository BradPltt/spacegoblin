...
public class queueSim{
    ...
    String save[][] = new String[4][250];//creates an array to save simulation information
    /**
    ...
    public queueSim(){
        ...
        while (keepGoing){
            ...
            if (choice.equals("H")){
            ...
            else if(choice.equals("P")) priorityQ(); //this runs the following code if the user inputs 'p'
            else if(choice.equals("B")) standardQ();
                ...
                if (choice.equals("S")) {
                    ...
                    saveFile();//if the user inputs 'S' then the standard queue information will be saved to an external txt file
                    choice=input.nextLine();
                }
            }
        }
                        ...
                        for (int i =1; i<=served; i++){
                            ...
                            if (!everyoneQueue.emptyQ()){
                                ...
                                if (john.teacher){
                                    ...
                                    String wait = Integer.toString(timeWaiting);
                                    save[2][lineNumber]= wait;
                                    save[0][lineNumber]="student";
                                    lineNumber++;
    ...
    void saveFile(){
        File theSimFile = new File("simulation report");
        System.out.println("saving");
        try{
            FileWriter writer = new FileWriter(theSimFile);
            writer.write("This is the file");
            for (int i=0;i<8;i++){
                writer.write(save[1][i]+System.getProperty("line.seperator"));
                System.getProperty("line.seperator");
                writer.write("this in the number i "+i);
            }
